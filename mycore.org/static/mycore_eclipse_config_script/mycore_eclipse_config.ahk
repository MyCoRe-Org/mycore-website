...
; Ermittelt die aktuelle Eclipse Version im geöffneten Eclipse und setzt sie in die globale "EclipseVersion" Variable
DetectCurrentEclipseVersion() {
	global EclipseVersion
	WinActivate, ahk_class SWT_Window0
	...
	clipboard := ""
	;Eclipse Version über "About Eclipse IDE" in EclipseVersion speichern
	Send, ^3
	...
	Send, ^a
	Send, ^c
	;warten bis die Zwischenablage Text enthält
	ClipWait
