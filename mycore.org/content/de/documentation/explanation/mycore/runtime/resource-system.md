---
aliases:
  - /documentation/basics/resources/res_index/
...
Ist ein [Developer-Override]({{< ref "/documentation/how-to-guides/mycore/development/use-development-mode" >}}) konfiguriert
...
Ist das [WCMS2]({{< ref "/documentation/reference/mycore/frontend/wcms" >}})-Modul vorhanden, so werden die Dateien im WCMS-Speicherverzeichnis
(typischerweise `/data/save/webpages` im [Konfigurationsverzeichnis]({{< ref "/documentation/reference/mycore/configuration/configuration-directory" >}}) der MyCoRe-Anwendung)
...
Die Dateien in `/resources` im [Konfigurationsverzeichnis]({{< ref "/documentation/reference/mycore/configuration/configuration-directory" >}}) der MyCoRe-Anwendung werden als Ressourcen verwendet.
