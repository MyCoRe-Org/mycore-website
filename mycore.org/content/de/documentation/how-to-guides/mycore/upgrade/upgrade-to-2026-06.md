---
aliases:
  - /documentation/migrate/migrate_mcr2026_06/
doc_type: how-to
product: mycore
...
man in der [Solr-Dokumentation]({{< ref "/documentation/reference/mycore/search/solr-integration" >}}).
    </p>
...
[konfigurierbaren Komponente]({{< ref "/documentation/reference/mycore/configuration/configurable-instances" >}})
