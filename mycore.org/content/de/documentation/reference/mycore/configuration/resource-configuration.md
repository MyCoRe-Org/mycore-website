---
aliases:
  - /documentation/basics/resources/res_config/
doc_type: reference
product: mycore
...
Eine Kombination mit Namen `default` für die [Standardkonfiguration]({{< ref "/documentation/explanation/mycore/runtime/resource-system#standardkonfiguration-des-resource-resolvers" >}}) und
eine Kombination mit Namen `legacy`, die eher das Verhalten von MyCoRe vor {{<mcr-version "2023.08">}} weitestgehend nachbildet
(siehe [Migrationsanleitung]({{< ref "/documentation/how-to-guides/mycore/upgrade/upgrade-to-2024-06#migrationsschritte" >}})).
...
> Der `MCRWCMSWebResourceProvider` wird nur in die Standardkonfiguration integriert, wenn das [WCMS2]({{< ref "/documentation/reference/mycore/frontend/wcms" >}})-Modul vorhanden ist.
...
Während der [Initialisierung]({{< ref "/documentation/explanation/mycore/runtime/application-lifecycle" >}}) der MyCoRe-Anwendung wird im Log die Struktur
